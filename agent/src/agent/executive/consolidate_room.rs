...
pub fn execute(o: DataObject) -> DataObject {
    ...
    let ax = panic::catch_unwind(panic::AssertUnwindSafe(|| {
        let arg_0: i64 = o.get_int("min_quiet_s");
        let arg_1: i64 = o.get_int("window");
        let arg_2: i64 = o.get_int("budget");
        consolidate_room(arg_0, arg_1, arg_2)
    }));
    match ax {
        Ok(ax) => {
            let mut result_obj = DataObject::new();
